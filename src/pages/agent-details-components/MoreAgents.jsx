...
const MoreAgents = ({ agent }) => {
  ...
  const filteredAgenst = reorderedAgent.filter((ag) => ag.id !== agent.id);
  return (
    <div className="max-w-screen-xl mx-auto">
      <div>
        ...
        {/* grid of agents  */}
        <div className="mt-6 grid gap-4 sm:grid-cols-2  lg:gap-4 lg:grid-cols-3  ">
          {filteredAgenst.map((agent) => (
